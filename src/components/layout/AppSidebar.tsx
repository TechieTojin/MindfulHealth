...
const menuItems = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { title: "AI Summary", icon: Sparkles, path: "/ai-summary" },
      { title: "Personalized Insights", icon: Lightbulb, path: "/personalized-insights" },
      { title: "Symptom Checker", icon: Stethoscope, path: "/symptom-checker" },
    ],
  },
];
      ...
      {isLoading ? (
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
                ...
                {/* Other menu groups would go here */}
                </div>
            ) : (
              <div>
